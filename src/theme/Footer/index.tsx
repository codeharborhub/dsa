    ...
    <footer
      ...
      style={{
        backgroundImage: `linear-gradient(#272329aa, #2d2c2d50, transparent),
                          url("/dsa/img/use-svg-as-background-image-particle-strokes.svg")`,
    ...
    >
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <Link to="#" className="mb-2 inline-block max-w-[80px]">
                <img src="/dsa/img/nav-logo.jpg" alt="logo" className="max-w-full" />
              </Link>
              ...
              <div className="flex flex-col gap-8">
                ...
                >
                  <div className="overflow-hidden rounded">
                    <img src="/dsa/img/blog-footer-01.jpg" alt="blog" />
                  </div>
                ...
                >
                  <div className="overflow-hidden rounded">
                    <img src="/dsa/img/blog-footer-02.jpg" alt="blog" />
                  </div>
                  <span className="max-w-[180px] text-base text-gray-300 group-hover:text-[--ifm-color-primary]">
      ...
      <div>
        <span className="absolute left-0 top-0 z-[-1]">
          <img src="/dsa/img/shape1.svg" alt="" />
        </span>

        <span className="absolute bottom-0 right-0 z-[-1]">
          <img src="/dsa/img/shape-3.svg" alt="" />
        </span>
